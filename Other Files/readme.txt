...
A driver must be installed to use the STU-520 and STU-530 color tablets, see: STU Driver Installation.
The driver must also be installed for all STU models on Windows 8.1 (to override Enhanced Power Management) and is recommended on Windows 10 for the STU-430.
...
documentation\
├───SignatureSDK-Components-API.pdf	        - PDF covering COM API.
└───SignatureSDK-Java API.pdf		        - PDF covering Java API.  

SignatureSDK\
├───Wacom-Signature-SDK-x86-4.7.1.msi       	- Installs 32-bit components on 32-bit or 64-bit Windows
└───Wacom-Signature-SDK-x64-4.7.1.msi       	- Installs 64-bit components on 64-bit Windows

SigCaptX\
└───Wacom-SigCaptX-1.25.3.exe               	- Installs 32-bit components on 32-bit or 64-bit Windows
...
Version History
  ...
  Release v3.0.4  05-March-2015
    ...
    For full details see Signature-Components-API.pdf and Signature-SDK-Release-V3.pdf
