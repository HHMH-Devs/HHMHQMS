Public Class frmCounterQueuingBoardQueueListAll
    ...
    Private Sub GetQueueList()
        If Not IsNothing(LoggedServer) Then
            ...
            Dim queueList = customerAssignCounterController.GetListOfCustomerInQueueAll()
    ...
    Private Sub frmCounterQueuingBoardQueueListAll_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        refreshDataIntertval.Start()
        showHelp()
    End Sub

    Private Sub frmCounterQueuingBoardQueueListAll_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
...
SKIP:
    ...
    Private Sub frmCounterQueuingBoardQueueListAll_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
