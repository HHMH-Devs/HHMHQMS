...
Public Class frmAllQueueBoardStandalone_Static
    ...
    Private Sub frmAllQueueBoardStandalone_Static_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        SetPagingConfig()
    ...
    Private Sub frmAllQueueBoardStandalone_Static_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmAllQueueBoardStandalone_Static_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        QueueListTimer.Stop()
    End Sub
End Class